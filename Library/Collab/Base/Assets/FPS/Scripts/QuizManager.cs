...
public class QuizManager : MonoBehaviour
{
    ...
    IEnumerator GetQuestion(Action<string> questionCallback, Action<String[], String> optionCallback){
    ...
    IEnumerator GetQuestionFromId(string questionId, Action<string> questionCallback, Action<String[], String> optionCallback){
        ...
        if(request.responseCode==200){
            ...
            questionCallback(questionObject.question);
    ...
    IEnumerator GetCampaignQuestion(Action<string> questionCallback, Action<String[], String> optionCallback){
    ...
    IEnumerator SendResults(){
        ...
        // resultObj.userId = PlayerLevel.userId;
        // resultObj.assignmentId = GameIdManager.gameId;
        // resultObj.score = PlayerLevel.score;
        // resultObj.wrongQuestionIDs = PlayerLevel.wrongQuestionIDs;
